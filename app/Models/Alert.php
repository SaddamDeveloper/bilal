...
class Alert extends Model
{
    ...
    public static function getAlert($user_id ,$offset, $limit, $platform, $currency_code){
    	$data = static::join('pairs','pairs.id','=','alerts.pair_id')
    	...
    	$data = $data->select('alerts.id','platforms.name as platform','currencies.code as currency_code','currencies.name as currency')
